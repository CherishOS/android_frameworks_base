...
import com.android.internal.util.cherish.ColorUtils;

import static com.android.internal.cherish.hardware.LiveDisplayManager.MODE_AUTO;
import static com.android.internal.cherish.hardware.LiveDisplayManager.MODE_DAY;
import static com.android.internal.cherish.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.cherish.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.cherish.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
