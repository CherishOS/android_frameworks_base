...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    private static final int BATTERY_STYLE_LANDSCAPE_BUDDY = 7;
    private static final int BATTERY_STYLE_LANDSCAPE_LINE = 8;
    private static final int BATTERY_STYLE_LANDSCAPE_MUSKU = 9;
    private static final int BATTERY_STYLE_LANDSCAPE_PILL = 10;
    private static final int BATTERY_STYLE_LANDSCAPE_SIGNAL = 11;
    private static final int BATTERY_STYLE_RLANDSCAPE_STYLE_A = 12;
    private static final int BATTERY_STYLE_LANDSCAPE_STYLE_A = 13;
    private static final int BATTERY_STYLE_RLANDSCAPE_STYLE_B = 14;
    private static final int BATTERY_STYLE_LANDSCAPE_STYLE_B = 15;
