...
public class CommandQueue extends IStatusBar.Stub implements
    ...
    private static final int MSG_SCREEN_PINNING_STATE_CHANGED      = 72 << MSG_SHIFT;
    private static final int MSG_LEFT_IN_LANDSCAPE_STATE_CHANGED   = 73 << MSG_SHIFT;
    private static final int MSG_KILL_FOREGROUND_APP  = 74 << MSG_SHIFT;
