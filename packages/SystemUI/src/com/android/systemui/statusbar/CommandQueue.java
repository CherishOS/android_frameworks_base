...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_KILL_FOREGROUND_APP               = 59 << MSG_SHIFT;
    private static final int MSG_TOGGLE_SETTINGS_PANEL             = 60 << MSG_SHIFT;
    private static final int MSG_SHOW_IN_DISPLAY_FINGERPRINT_VIEW  = 61 << MSG_SHIFT;
    private static final int MSG_HIDE_IN_DISPLAY_FINGERPRINT_VIEW  = 62 << MSG_SHIFT;
